...
public interface IPaymentGatewayService
{
    ...
    Task<Result<string>> CreateCheckoutSessionAsync(string sessionId, decimal amount, string currency, string? idempotencyKey, string? returnUrl, CancellationToken cancellationToken);
