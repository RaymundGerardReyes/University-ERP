...
describe('Schedule - End-to-End Testing', () => {
  it.todo('End-to-end scenarios should exercise Schedule through the real portal shell/router against a running (or mocked) backend, following the actual user journey.');
});
