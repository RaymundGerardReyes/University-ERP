...
import { AuditsPage } from '../../../apps/governance-console/src/features/Audits/Audits.page';
...
describe("Audits - Integration Testing", () => {
  ...
  it("loads Audits view controller and mounts accessible heading", async () => {
    renderComponent();
    await waitFor(() => {
  ...
  it("verifies Audits feature layout and operational state", async () => {
    renderComponent();
    await waitFor(() => {
