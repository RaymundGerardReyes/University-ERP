...
import { VisitorsPage } from '../../../apps/governance-console/src/features/Visitors/Visitors.page';
...
describe("Visitors - Integration Testing", () => {
  ...
  it("loads Visitors view controller and mounts accessible heading", async () => {
    renderComponent();
    await waitFor(() => {
  ...
  it("verifies Visitors feature layout and operational state", async () => {
    renderComponent();
    await waitFor(() => {
