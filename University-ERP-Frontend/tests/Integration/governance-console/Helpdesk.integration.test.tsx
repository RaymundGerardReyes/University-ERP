...
import { HelpdeskPage } from '../../../apps/governance-console/src/features/Helpdesk/Helpdesk.page';
...
describe("Helpdesk - Integration Testing", () => {
  ...
  it("loads Helpdesk view controller and mounts accessible heading", async () => {
    renderComponent();
    await waitFor(() => {
  ...
  it("verifies Helpdesk feature layout and operational state", async () => {
    renderComponent();
    await waitFor(() => {
