...
import { CompliancePage } from '../../../apps/governance-console/src/features/Compliance/Compliance.page';
...
describe("Compliance - Integration Testing", () => {
  ...
  it("loads Compliance view controller and mounts accessible heading", async () => {
    renderComponent();
    await waitFor(() => {
  ...
  it("verifies Compliance feature layout and operational state", async () => {
    renderComponent();
    await waitFor(() => {
