...
describe("CertificationDivision - Integration Testing", () => {
  ...
  const renderComponent = () =>
    render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
          <DiplomaVerificationPage />
        </MemoryRouter>
      </QueryClientProvider>
    );

  it("loads CertificationDivision division interface and mounts accessible heading", async () => {
    renderComponent();
    await waitFor(() => {
  ...
  it("verifies CertificationDivision workspace container and operational state", async () => {
    renderComponent();
    await waitFor(() => {
