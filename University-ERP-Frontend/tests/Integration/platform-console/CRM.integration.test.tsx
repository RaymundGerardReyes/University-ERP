...
import { CRMPage } from '../../../apps/platform-console/src/features/CRM/CRM.page';
...
describe("CRM - Integration Testing", () => {
  ...
  it("loads CRM view controller and mounts accessible heading", async () => {
    renderComponent();
    await waitFor(() => {
  ...
  it("verifies CRM feature layout and operational state", async () => {
    renderComponent();
    await waitFor(() => {
