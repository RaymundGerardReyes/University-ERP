...
import { NotificationPage } from '../../../apps/platform-console/src/features/Notification/Notification.page';
...
describe("Notification - Integration Testing", () => {
  ...
  it("loads Notification view controller and mounts accessible heading", async () => {
    renderComponent();
    await waitFor(() => {
  ...
  it("verifies Notification feature layout and operational state", async () => {
    renderComponent();
    await waitFor(() => {
