...
describe("FacilityBooking - Integration Testing", () => {
  ...
  it("loads FacilityBooking view controller and mounts accessible interface", async () => {
    renderComponent();
    await waitFor(() => {
  ...
  it("verifies FacilityBooking container structure and layout stability", async () => {
    renderComponent();
    await waitFor(() => {
