...
describe('Calendar - Unit Testing', () => {
  it.todo("Unit-test scenarios should cover Calendar's hooks, pure rendering states, and prop-driven behavior in isolation, with the API layer mocked.");
});
