...
describe('ApplicationStatus Feature', () => {
  ...
  it('TC12: ApplicationStatus_Should_Display_Status_Accurately_Reflecting_Backend_Status', async () => {
    mockGetApplicationStatus.mockResolvedValue([
      { id: 'APP-01', programName: 'BS Computer Science', status: 'Under Review', submittedDate: '2026-08-01' }
    ]);
    render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
