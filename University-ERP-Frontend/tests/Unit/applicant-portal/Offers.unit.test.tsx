...
vi.mock('@university-erp/auth-sdk', () => ({
  useAuth: () => ({
    identity: { id: 'applicant-123', name: 'Alex Johnson' },
    user: { id: 'applicant-123', name: 'Alex Johnson' },
  }),
}));
      ...
      programs: [
        {
          ...
          duration: '4 Years',
          intake: 'Fall 2026',
          tuitionEstimate: '$5,000/sem',
          tags: ['STEM', 'Accredited'],
        },
      ],
      documents: [],
      timeline: [],
...
describe('Offers Feature', () => {
  ...
  it('TC13: Offers_Should_Render_Accept_Offer_Button_When_Status_Is_Accepted', async () => {
    renderComponent();
    await waitFor(() => {
      expect(screen.getByRole('button', { name: /Accept Offer & Reserve Seat/i })).toBeInTheDocument();
