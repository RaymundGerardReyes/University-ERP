...
import { DigitalResourcesPage } from '../../../apps/library-portal/src/features/DigitalResources/DigitalResources.page';
...
describe("DigitalResources - Unit Testing", () => {
  ...
  it("renders DigitalResources page heading", async () => {
    render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
          <DigitalResourcesPage />
        </MemoryRouter>
      </QueryClientProvider>
    );
    await waitFor(() => {
