...
import { EmailProvisioningPage } from '../../../apps/identity-portal/src/features/Email/EmailProvisioning.page';
...
describe("Email - Unit Testing", () => {
  ...
  it("renders Email page heading", async () => {
    render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
          <EmailProvisioningPage />
        </MemoryRouter>
      </QueryClientProvider>
    );
    await waitFor(() => {
