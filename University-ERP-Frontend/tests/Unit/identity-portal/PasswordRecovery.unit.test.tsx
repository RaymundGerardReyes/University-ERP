...
import { PasswordRecoveryPage } from '../../../apps/identity-portal/src/features/PasswordRecovery/PasswordRecovery.page';
...
describe("PasswordRecovery - Unit Testing", () => {
  ...
  it("renders PasswordRecovery page heading", async () => {
    render(
