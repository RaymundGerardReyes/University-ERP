...
import SessionManagement from '../../../apps/identity-portal/src/features/SessionManagement/SessionManagement.page';
...
vi.mock('@university-erp/api-clients', () => ({
  ...
  identityApi: {
    ...
    getSessions: vi.fn().mockResolvedValue([
      { sessionId: 'sess-1', device: 'Chrome on Windows', location: 'Campus Library', lastActive: '2026-09-01T12:00:00Z' }
    ])
  },
  libraryCatalogApi: {
...
describe("SessionManagement - Unit Testing", () => {
  ...
  it("renders SessionManagement page heading", async () => {
    render(
