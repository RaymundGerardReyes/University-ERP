...
import { AccountProvisioningPage } from '../../../apps/identity-portal/src/features/UniversityAccount/AccountProvisioning.page';
...
describe("UniversityAccount - Unit Testing", () => {
  ...
  it("renders UniversityAccount page heading", async () => {
    render(
