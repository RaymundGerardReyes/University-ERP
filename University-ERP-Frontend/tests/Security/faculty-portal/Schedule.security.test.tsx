...
describe('Schedule - Security Testing', () => {
  it.todo('Security scenarios should verify Schedule enforces its auth guard, does not leak restricted data before authorization resolves, and does not expose sensitive fields in the DOM/network payload.');
});
