...
export default function AppShell() {
    return (_jsxs("div", { style: { minHeight: '100vh', display: 'flex', flexDirection: 'column', background: 'hsl(220, 30%, 15%)' }, children: [_jsx("header", { style: {
                    ...
                    zIndex: 10
                            ...
                            }, children: "G" }), _jsx("h1", { style: { color: 'white', margin: 0, fontSize: '1.2rem', fontWeight: 600 }, children: "Governance Console" })] }) }), _jsx("main", { style: { flex: 1, padding: '2rem', display: 'flex', flexDirection: 'column' }, children: _jsx(Outlet, {}) }), _jsxs("footer", { style: {
                    padding: '1.5rem',
                    textAlign: 'center',
                    color: 'rgba(255, 255, 255, 0.4)',
                    fontSize: '0.85rem',
                    borderTop: '1px solid rgba(255, 255, 255, 0.05)'
                }, children: ["\u00A9 ", new Date().getFullYear(), " University ERP Governance Console."] })] }));
}
