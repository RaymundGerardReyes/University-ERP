...
import { Card, PageHeader, Badge, EmptyState } from '@university-erp/ui-kit';
...
export const ApplicationTimelinePage: React.FC = () => {
  ...
  const { data: journey, isLoading, isError } = useApplicationTimeline();
      ...
      <div className="fade-in">
        ...
        <Card style={{ maxWidth: '800px', margin: '0 auto' }}>
          <EmptyState
            ...
            description="Please log in to view your application timeline."
          />
        </Card>
      </div>
    );
