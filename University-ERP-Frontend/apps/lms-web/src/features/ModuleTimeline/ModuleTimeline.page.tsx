...
import { useModuleTimeline } from './ModuleTimeline.hooks';

export const ModuleTimelinePage: React.FC = () => {
  const navigate = useNavigate();
  const { data: serverModules } = useModuleTimeline('CS-101');

  const course = {
    code: 'CS-101',
    title: 'Introduction to Computer Science',
    faculty: 'Dr. Alan Turing',
    modules: serverModules && serverModules.length > 0 ? serverModules : [
      { id: 'MOD-1', title: 'Week 1: Fundamentals of Logic', status: 'Completed' as const, type: 'Lesson' as const },
      { id: 'MOD-2', title: 'Week 2: Control Structures', status: 'Active' as const, type: 'Lesson' as const },
      { id: 'MOD-3', title: 'Assignment: First Algorithm', status: 'Pending' as const, type: 'Assignment' as const, due: 'In 3 days' },
      { id: 'MOD-4', title: 'Quiz: Boolean Logic', status: 'Locked' as const, type: 'Quiz' as const, due: 'Next Week' },
    ]
  };
