...
export const WorkflowManagementPage: React.FC = () => {
    ...
    const [cronSchedule, setCronSchedule] = useState('0 17 * * 5');
    ...
    return (
        <div className="fade-in">
            ...
            {/* Visual Builder Canvas & Triggers */}
            <Card className="fade-in-delay-1" style={{ marginBottom: 'var(--space-6)' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 'var(--space-4)' }}>
                    <h2 style={{ fontSize: '1.2rem', margin: 0, color: 'var(--text-primary)' }}>Visual Workflow Canvas</h2>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)' }}>
                        <label htmlFor="cron-schedule" style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>CRON Schedule:</label>
                        <input
                            id="cron-schedule"
                ...
                >
                    Drag and drop trigger and action nodes onto this workflow canvas
                </div>
            </Card>
