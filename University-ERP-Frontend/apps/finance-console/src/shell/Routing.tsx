...
import { FinancialReportsPage } from '../features/FinancialReports/FinancialReports.page';

// Invoicing & Receivables
import { InvoicingPage } from '../features/Invoicing/Invoicing.page';

// Tuition Assessment & Student Billing
...
// Corporate & Payroll
import { BudgetingPage } from '../features/Budgeting/Budgeting.page';
    ...
    <BrowserRouter basename={import.meta.env.BASE_URL}>
      <Routes>
        <Route element={<AuthGuard><AppShell /></AuthGuard>}>
          ...
          {/* Invoicing & Student Billing Workspace */}
          <Route element={<FinanceGuard allowedRoles={['ROLE_FINANCE_ADMIN', 'ROLE_FINANCE_ASSESSOR']} />}>
          ...
          {/* Corporate, Budgeting & Payroll */}
          <Route element={<FinanceGuard allowedRoles={['ROLE_FINANCE_ADMIN']} />}>
