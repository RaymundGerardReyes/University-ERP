...
public partial class LoginViewModel : ObservableObject
{
    ...
    public async Task AuthenticateAsync()
    {
        ...
        if (result.IsSuccess)
        {
            ...
            if (_navigateToDashboard != null && App.Current?.Services != null)
            {
                var dashboardVm = App.Current.Services.GetService(typeof(StudentDashboardViewModel)) as StudentDashboardViewModel;
                if (dashboardVm != null)
                {
